...
<form:form action="/admin/setQuest/${tId}/setTopic/" method="POST">
    ...
    <input name="submit" type="submit" class="myButton" value="submit"/>
        ...
        <form:form action="/admin/setQuest/${tId}/deleteTest/" method="POST">
            <input name="submit" type="submit" class="myButton" value="submit"/>
        </form:form>
    </div>
<%}%>
